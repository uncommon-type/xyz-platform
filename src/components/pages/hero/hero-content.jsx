import { robotoLight, poppins } from 'styles/fonts/fonts';
...
const HeroContent = () => (
  <div className="flex flex-col flex-wrap justify-center items-stretch font-roboto-light text-xl leading-normal tracking-wide">
    <article className="flow relative">
      <h1
        className={`mt-[min(10.5rem, 30vh)] text-grey-98 ${poppins.className} leading-4.5 tracking-tighter text-shadow`}
      >
      ...
      <p className={`text-grey-94 text-lg ${robotoLight.className} tracking-wider`}>
